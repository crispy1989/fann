...
/* Function: fann_set_user_data_string

    Store a user-defined string.  A copy is made of the string and the memory is
    automatically freed when the fann is freed.

    Parameters:
		ann - Neural network structure
		str - User data string
*/

FANN_EXTERNAL void FANN_API fann_set_user_data_string(struct fann *ann, const char *str);

/* Function: fann_get_user_data_string

    Retrieve the user-defined string.

    Parameters:
		ann - Neural network structure
*/
FANN_EXTERNAL char * FANN_API fann_get_user_data_string(struct fann *ann);
